...
function App() {
  ...
  const Home = () => {
    ...
    return (
      <div>
        <p style={{fontSize:'24px'}}>Address: {account}</p>
        <br />
        <h1>Count: {count}</h1>
        <br />
        <div style={{display:"flex", gap:"10px"}}>

        <button style={{padding:"10px 15px"}} onClick={increaseCount}>increment</button>
        <button style={{padding:"10px 15px"}} onClick={decreaseCount}>Decrement</button>
        <button style={{padding:"10px 15px"}} onClick={resetCount}>Reset Count</button>
        <button style={{padding:"10px 15px"}} onClick={getBalance}>Get Contract Balance</button>
        </div>
      </div>
    );
  };
